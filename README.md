...
- **Export/Import** — backup and share favorites with unique protection codes
...
### Upcoming Updates
- [x] **Data export/import** — favorites backup and sharing with protection codes ✅
...
- **Экспорт/Импорт** — резервное копирование и обмен избранным с уникальными кодами защиты
...
- [x] **Экспорт/Импорт данных** — резервное копирование и обмен избранным с кодами защиты ✅
